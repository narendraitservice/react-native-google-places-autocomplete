...
export default class GooglePlacesAutocomplete extends Component {
  ...
  _renderRowData = (rowData) => {
    ...
    return (
          <Text style={[{flex: 1,marginTop: 2,marginLeft: 5}, this.props.suppressDefaultStyles ? {} : defaultStyles.description, this.props.styles.description, rowData.isPredefinedPlace ? this.props.styles.predefinedPlacesDescription : {}]}
      ...
      <ScrollView
        ...
        >
          ...
          <View style={[this.props.suppressDefaultStyles ? {} : defaultStyles.row, this.props.styles.row, rowData.isPredefinedPlace ? this.props.styles.specialItemRow : {}]}>
            <Icon type="MaterialIcons" name="location-on" style={{fontSize:20}} />
      ...
      >
        {!this.props.textInputHide &&
          ...
          >
            ...
            <Icon style={{position :'absolute',zIndex:1,fontSize:18,top:9,left:10}} name={'ios-search'} />
            <TextInput
              ref="textInput"
